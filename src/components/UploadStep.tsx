      ...
      <div className="flex flex-col gap-6">
        <div className="card p-6">
          ...
          <ol className="mt-4 space-y-4">
            {[
              ["01", "Автоанализ", "Определяем размер пикселя (модуля) QR-кода прямо по фото и строим сетку."],
              ["02", "Построчная проверка", "Для каждого модуля приложение предполагает цвет — вы подтверждаете или инвертируете."],
              ["03", "Готовый код", "Из подтверждённых пикселей собирается QR, который можно сохранить как JPEG."],
            ].map(([num, title, text]) => (
